...
# NOTE (wtweaks): AtlasModules init removed, not needed in -Silent mode.
# toggleDev.cmd is bundled next to this script (.\Power\) instead of %windir%\AtlasModules.
...
& ".\Power\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
