# Standalone version of Atlas OS Set-Theme (Atlas 0.4.1, Themes.psm1).
# Applies a .theme file via the official theme API so wallpaper, dark mode
# and accent take effect immediately, without needing a reboot.
param (
